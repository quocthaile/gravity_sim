...
int main()
{
    ...
    objs = {
        // Object(glm::vec3(3844, 0, 0), glm::vec3(0, 0,
        // 228), 7.34767309*pow(10, 22), 3344),
        ...
        Object(glm::vec3(-5000, 650, -350), glm::vec3(0, 0, 1500),
               5.97219 * pow(10, 22), 5515, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f)),
        Object(glm::vec3(5000, 650, -350), glm::vec3(0, 0, -1500),
               5.97219 * pow(10, 22), 5515, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f)),
        Object(glm::vec3(0, 0, -350), glm::vec3(0, 0, 0), 1.989 * pow(10, 25),
            ...
            for (auto &obj2 : objs)
            {
                if (&obj2 != &obj && !obj.Initalizing && !obj2.Initalizing)
                {
                    ...
                    if (distance > 0)
                    {
                        ...
                        distance *= 1000;
                        double Gforce =
                            (G * obj.mass * obj2.mass) / (distance * distance);
                 ...
                 int mods)
{
    ...
    if (!objs.empty() && objs[objs.size() - 1].Initalizing)
    {
            ...
            (action == GLFW_PRESS || action == GLFW_REPEAT))
        {
            if (!shiftPressed)
            {
                objs[objs.size() - 1].position[1] +=
                    objs[objs.size() - 1].radius * 0.2;
            }
        };
